...
//           {/* LEFT PANEL */}
//           <div className="bg-linear-to-br from-[#c43232] via-[#d63f3f] to-[#f34c4c]
//                           text-white p-12 flex flex-col justify-between">
...
//                   <MapPin className="mt-1 text-white/80" />
//                   <p>
//                     Mandideep, Raisen<br />
...
//                 <div className="flex gap-4 items-start">
//                   <Clock className="mt-1 text-white/80" />
//                   <p>
...
//                 <div className="flex gap-4 items-start">
//                   <Phone className="mt-1 text-white/80" />
//                   <p>+91 XXXXXXXXXX</p>
//                 </div>

//                 <div className="flex gap-4 items-start">
//                   <Mail className="mt-1 text-white/80" />
...
//             {/* SOCIAL */}
//             <div className="mt-12">
//               <p className="mb-4 text-sm font-semibold tracking-wide uppercase text-white/80">
//                 Get Us On
//               </p>
...
//                                  hover:bg-white hover:text-[#c43232]
...
//                            focus:ring-2 focus:ring-[#d84343] outline-none"
//               />
